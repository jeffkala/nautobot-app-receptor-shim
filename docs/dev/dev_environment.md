...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 2.1.0)
- `project_name`: the default docker compose project name (default: `receptor-shim`)
...
#14 naming to docker.io/receptor-shim/nautobot:2.1.0-py3.11 done
```
...
Creating network "receptor_shim_default" with the default driver
Creating volume "receptor_shim_postgres_data" with default driver
Creating receptor_shim_redis_1 ...
Creating receptor_shim_docs_1  ...
Creating receptor_shim_postgres_1 ...
Creating receptor_shim_postgres_1 ... done
Creating receptor_shim_redis_1    ... done
Creating receptor_shim_nautobot_1 ...
Creating receptor_shim_docs_1     ... done
Creating receptor_shim_nautobot_1 ... done
Creating receptor_shim_worker_1   ...
Creating receptor_shim_worker_1   ... done
...
ee90fbfabd77   receptor-shim/nautobot:2.1.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               receptor_shim_worker_1
b8adb781d013   receptor-shim/nautobot:2.1.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   receptor_shim_nautobot_1
d64ebd60675d   receptor-shim/nautobot:2.1.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   receptor_shim_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   receptor_shim_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   receptor_shim_redis_1
```
...
Stopping receptor_shim_worker_1   ...
Stopping receptor_shim_nautobot_1 ...
Stopping receptor_shim_docs_1     ...
Stopping receptor_shim_redis_1    ...
Stopping receptor_shim_postgres_1 ...
Stopping receptor_shim_worker_1   ... done
Stopping receptor_shim_nautobot_1 ... done
Stopping receptor_shim_postgres_1 ... done
Stopping receptor_shim_redis_1    ... done
Stopping receptor_shim_docs_1     ... done
Removing receptor_shim_worker_1   ...
Removing receptor_shim_nautobot_1 ...
Removing receptor_shim_docs_1     ...
Removing receptor_shim_redis_1    ...
Removing receptor_shim_postgres_1 ...
Removing receptor_shim_postgres_1 ... done
Removing receptor_shim_docs_1     ... done
Removing receptor_shim_worker_1   ... done
Removing receptor_shim_redis_1    ... done
Removing receptor_shim_nautobot_1 ... done
Removing network receptor_shim_default
```
...
So for example, our app is named `receptor-shim`, the command would most likely be `docker logs receptor_shim_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("receptor_shim")
namespace.configure(
    {
        "receptor_shim": {
            ...
...
Or set the `INVOKE_RECEPTOR_SHIM_PYTHON_VER` variable.
...
Or set the `INVOKE_RECEPTOR_SHIM_NAUTOBOT_VER` variable.
...
In the package source, there is the `receptor_shim/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
